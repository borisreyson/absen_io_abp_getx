...
class HazardKeSaya extends StatefulWidget {
  final String option;
  final int disetujui;
  const HazardKeSaya({Key? key, required this.option, required this.disetujui})
      : super(key: key);

  @override
  State<HazardKeSaya> createState() => _HazardKeSayaState();
}

class _HazardKeSayaState extends State<HazardKeSaya> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: const Text("Hazard Report Ke Saya"),
        ),
        backgroundColor: _colorList.elementAt(_selectedIndex!),
        body: _getData());
  }
