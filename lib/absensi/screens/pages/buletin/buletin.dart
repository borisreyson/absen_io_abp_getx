...
import 'package:face_id_plus/absensi/screens/pages/buletin/add_buletin.dart';
import 'package:face_id_plus/absensi/screens/pages/buletin/detail_buletin.dart';
...
class _BuletinState extends State<Buletin> {
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () async {
          var tambahData = await Navigator.push(
              context, MaterialPageRoute(builder: ((context) => AddBuletin())));
          if (tambahData == "Ok") {
            setState(() {});
          }
        },
  ...
  hapusBuletin(int idInfo) async {
    await ApiBuletin.deleteBuletin(idInfo).then((value) {
      if (value!.success!) {
