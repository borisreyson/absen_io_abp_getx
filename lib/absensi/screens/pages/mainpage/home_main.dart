...
import 'package:face_id_plus/absensi/screens/pages/profile/profile.dart';
import 'package:face_id_plus/absensi/services/net_check.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  void initState() {
    ...
    setState(() {
      ...
      now =
          DateTime(old.year, old.month, old.day, mulai.hour, mulai.minute, 00);
  ...
  Widget _loadMaps(List<Polygon> _shape, List<LatLng> pointAbp) {
    ...
    return GoogleMap(
      ...
      onMapCreated: (GoogleMapController controller) async {
        ...
        markers.add(marker);
        _googleMapController.showMarkerInfoWindow(const MarkerId("abpenergy"));
      },
