...
import 'package:face_id_plus/absensi/screens/pages/maps/maps.dart';
              ...
              Column(
                children: <Widget>[
                  ElevatedButton(
                      ...
                      onPressed: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (BuildContext context) => PointMaps(1,
                                    _map.idLok, LatLng(_map.lat!, _map.lng!))));
                      },
                      child: const Text(
                        "Edit",
                  ...
                  ElevatedButton(
                      ...
                      onPressed: () {
                        _provider.delMapPoint("${_map.idLok}")
