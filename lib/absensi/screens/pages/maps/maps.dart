...
class PointMaps extends StatefulWidget {
  ...
  const PointMaps(this.btnAdd, this.idLok, this.savedLok, {Key? key})
      : super(key: key);
  @override
...
class _PointMapsState extends State<PointMaps> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(backgroundColor: const Color(0xFF21BFBD), elevation: 0),
            ...
            child: Row(
              ...
              children: [
                Column(
                  ...
                  children: <Widget>[
                    (widget.btnAdd == 1)
                        ? Text("ID LOK : ${widget.idLok}")
                        : Container(),
                    (widget.btnAdd == 1)
                        ? Text("OLD LAT : ${widget.savedLok?.latitude}")
                        : Container(),
                    (widget.btnAdd == 1)
                        ? Text("OLD LNG : ${widget.savedLok?.longitude}")
                        : Container(),
                ...
                (widget.btnAdd == 0)
                    ? ElevatedButton(
                        onPressed: () {
                          _provider
                              .saveMapPoint("${myLocation!.latitude}",
