...
class Lampiran extends StatefulWidget {
  final String _status;
  const Lampiran(this._status, {Key? key}) : super(key: key);

  @override
  State<Lampiran> createState() => _LampiranState();
}

class _LampiranState extends State<Lampiran> {
  late String _status;
  @override
  void initState() {
